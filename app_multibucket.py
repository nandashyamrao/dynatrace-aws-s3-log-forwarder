...
def lambda_handler(event, context):
    ...
    # Support comma-separated list of allowed buckets via env var
    allowed_buckets = os.getenv("ALLOWED_BUCKETS", "sf-infosec-cloudfront-logs").split(",")
    ...
    for index, message in enumerate(event_records):
        ...
        try:
            ...
            # ✅ Allow multiple whitelisted buckets
